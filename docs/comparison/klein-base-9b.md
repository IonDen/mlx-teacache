...
Recipe: 50 steps, guidance 4.0, q4, 768×1024, seed 42, text encoders freed once the prompt is encoded. Checkpoint `black-forest-labs/FLUX.2-klein-base-9B`; preview decoder `taef2`. mlx-teacache 0.11.1, mflux 0.20.0, MLX 0.32.2, mlx-taef 0.8.3. Multi-run measurement of this model: [bench report](../../_artifacts/v0.10.0_bench_klein_base_9b.json).
